...
//
//
//        JSONObject req = RequestFormat.createRequestObj("lastNotificationTimestamp",args);
//
//        socket.emit("lastNotificationTimestamp", req, new Ack() {
//            @Override
//            public void call(Object... args) {
//                if(generalHandler(args)==200){
...
//                        //AppData.userToken = notificationsR.data.notifications;
//                    }
